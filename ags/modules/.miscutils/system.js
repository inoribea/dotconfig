...
export const isArchDistro = (distroID == 'arch' || distroID == 'endeavouros' || distroID == 'cachyos' || distroID == 'manjaro');
...
export const getDistroIcon = () => {
    ...
    if(distroID == 'manjaro') return 'manjaro-symbolic';
    // Funny flake
...
export const getDistroName = () => {
    ...
    if(distroID == 'manjaro') return 'manjaro';
    // Funny flake
